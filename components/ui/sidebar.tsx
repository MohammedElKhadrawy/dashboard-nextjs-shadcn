...
function SidebarTrigger({
  ...
  const Icon = isMobile ? Menu : PanelLeftIcon
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      // added ! to w-auto in order to fix the overflow
...
function SidebarMenuSubItem({
  ...
  return (
    <li
      ...
      // added a before pseudo-element classes for the tree-like connector between items
      className={cn(
        "group/menu-sub-item relative before:absolute before:-inset-s-3 before:bottom-1/2 before:w-3 before:rounded-es-md before:border-s before:border-b not-first:before:h-3/2 first:before:h-1/2",
        className
      )}
      {...props}
    />
