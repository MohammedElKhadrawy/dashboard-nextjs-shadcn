      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton asChild tooltip="See All Projects">
                  <Link href="/#">
                    <Projector />
        ...
        {/* Group 4 Nested + Collapsible Submenu */}
        <Collapsible defaultOpen className="group/collapsible">
          <SidebarGroup>
            <SidebarGroupLabel>Nested & Collapsible Submenu</SidebarGroupLabel>
          ...
          <SidebarMenuItem>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <SidebarMenuButton>
                  <User2 /> John Doe <ChevronsUpDown className="ms-auto" />
                </SidebarMenuButton>
              </DropdownMenuTrigger>
